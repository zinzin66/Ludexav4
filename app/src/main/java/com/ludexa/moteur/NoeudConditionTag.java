...
public class NoeudConditionTag extends NoeudBase {
    ...
    public NoeudConditionTag() {
        super(genererId(), "Si Objet a le Tag", "Logique & Conditions");
    ...
    public void executer() {
        ...
        boolean aLeTag = false;
        
        if (obj != null && tagAttendu != null) {
            aLeTag = tagAttendu.equals(obj.tag);
        }
    ...
    @Override
    public List<String> getNomsParametres() { return Arrays.asList("Tag attendu"); }

    @Override
    public String getValeurParametre(String nom) {
        if ("Tag attendu".equals(nom)) return tagAttendu;
        return "";
    }

    @Override
    public void setValeurParametre(String nom, String valeur) {
        if ("Tag attendu".equals(nom)) tagAttendu = valeur;
    }
