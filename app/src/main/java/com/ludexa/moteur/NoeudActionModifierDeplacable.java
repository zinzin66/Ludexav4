...
public class NoeudActionModifierDeplacable extends NoeudBase {
    ...
    public void executer() {
        ...
        if (cibleActuelle != null && valeurDeplacable != null) {
            String val = valeurDeplacable.trim().toLowerCase();
            boolean estVisible = val.equals("true") || val.equals("vrai") || val.equals("oui");
            cibleActuelle.estDeplacable = estVisible;
        }
    ...
    public List<String> getNomsParametres() { 
        return Arrays.asList("Déplaçable"); 
    }

    @Override
    public String getValeurParametre(String nom) { 
        return valeurDeplacable; 
    }

    @Override
    public void setValeurParametre(String nom, String valeur) { 
        valeurDeplacable = valeur; 
    }
