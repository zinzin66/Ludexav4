...
public class NoeudActionBoutonAction extends NoeudBase {

    private String etat = "Masquer"; // "Afficher" ou "Masquer"

    public NoeudActionBoutonAction() {
        super(genererId(), "Afficher/Masquer Action", "Scène & HUD");
            ...
            try {
                ...
                if (s != null && s.objets != null) {
                    for (ObjetBase o : s.objets) {
                        if ("bouton_action".equals(o.type)) {
